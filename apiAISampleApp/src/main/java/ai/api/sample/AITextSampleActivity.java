    ...
    */
    ...
    private void onResult(final AIResponse response) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                Log.d(TAG, "onResult");
                 // resultTextView.setText(gson.toJson(response.getResult().getFulfillment().getMessages()));
                resultTextView.setText(gson.toJson(response.getResult().getFulfillment().getSpeech().replace("\u0027"," ")));
